...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210181331-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Oct 18, 2022 13:31 EDT
# @@File             :  install.sh
# @@Description      :  
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/lighttpd"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="lighttpd"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/lighttpd"
APPDIR="$HOME/.local/share/srv/docker/lighttpd"
DATADIR="$HOME/.local/share/srv/docker/lighttpd/rootfs"
...
TZ=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default lighttpd
CONTAINER_HOSTNAME=""
